...
public class MyNewsAdapter extends ArrayAdapter<News> {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if (newsItemView == null) {
            ...
            viewHolder.contentTextView = newsItemView.findViewById(R.id.title_of_item);
            viewHolder.timeofmouth = newsItemView.findViewById(R.id.moth_of_time);
            viewHolder.dataofyear = newsItemView.findViewById(R.id.year_of_data);
            viewHolder.pictureImage = newsItemView.findViewById(R.id.image_of_item);
